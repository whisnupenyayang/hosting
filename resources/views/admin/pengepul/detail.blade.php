...
<div class="row">
    ...
    <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" id="harga" name="harga" class="form-control @error('harga') is-invalid @enderror" value="{{ old('harga', $pengepul->harga) }}" required>
                        @error('harga')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="nomor_telepon" name="nomor_telepon" class="form-control @error('nomor_telepon') is-invalid @enderror" value="{{ old('nomor_telepon', $pengepul->nomor_telepon) }}" required>
                        @error('nomor_telepon')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
        ...
        <!-- Separate Delete Form (moved outside update form) -->
        <div class="card mt-3">
            <div class="card-body">
                <form action="{{ route('admin.pengepul.destroy', $pengepul->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus data ini?')" class="d-inline">
                    @csrf
                    @method('DELETE')
