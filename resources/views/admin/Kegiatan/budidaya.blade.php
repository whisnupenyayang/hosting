        ...
        <section class="col-lg-12 connectedSortable">
                ...
                @foreach ($tahapanBudidaya->groupBy('nama_tahapan') as $namaTahapan => $tahapans)
                    <div class="tahapan-item mb-3 p-3 border rounded d-flex justify-content-between align-items-center">
                        <div class="tahapan-text">
                            <h5 class="mb-0">
                                <a href="{{ route('kegiatan.data_budidaya', ['nama_tahapan' => Str::slug($namaTahapan), 'jenis_kopi' => request('jenis_kopi')]) }}"
            ...
            <div style="position: relative; margin-bottom: 30px;">
                <div style="display: flex; justify-content: flex-end;">
                    <a href="{{ route('kegiatan.budidaya.create') }}" class="add-btn">
